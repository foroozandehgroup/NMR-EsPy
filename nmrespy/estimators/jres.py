...
# Last Edited: Fri 13 Jan 2023 12:49:20 GMT
...
class Estimator2DJ(_Estimator1DProc):
    ...
    def write_cupid_to_bruker(
        ...
        """Write the dataset generated by :py:meth:`cupid_signal` to a Bruker dataset.
        ...
        force_overwite
            If ``False``, and ``<path>/<expno>`` already exists, you will be asked
            if you are happy to overwrite. If ``True``, overwriting will take place
            without asking.
        """
        self._check_results_exist()
        sanity_check(
