...
# Last Edited: Mon 06 Mar 2023 14:27:41 GMT
...
class Estimator2DJ(_Estimator1DProc):
    ...
    def view_data(
        ...
        """View the data FID or the spectral data with an interactive matplotlib
        figure.
    ...
    def spectrum(self) -> np.ndarray:
        """Generate the spectrum of the data.

        Generated by halving the FID at index ``[0, 0]``, and applying FT.
        """
