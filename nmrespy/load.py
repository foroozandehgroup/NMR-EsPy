...
def import_bruker(directory, ask_convdta=True):
    ...
    *Digital Filters*
    ...
    1. **Importing a 1D fid file** \ This file wasgenerated by taking the
       example data `path/to/topspin/examdata/exam1d_1H/1`, and applying
       `convdta` to generate `path/to/topspin/examdata/exam1d_1H/1000`

       .. code:: python

          >>> from nmrespy.load import import_bruker
          >>> path = '/opt/topspin4.0.8/examdata/exam1d_1H/1000'
          >>> info = import_bruker(path)
          WARNING: It is necessary that the FID you import has been
          digitally filtered, using the <convdta> command in TopSpin.
          If you have not done this, please do so before proceeding
          If you wish to proceed, enter [y]
          If you wish to quit, enter [n]: y
          >>> info
          {'datatype': 'fid',
          'data': array([ 3.263654e+06+4.118010e+06j,
          4.906420e+06-8.190270e+05j, -2.278776e+06-3.506164e+06j, ...,
          5.590000e+02-3.120000e+02j, -2.700000e+02-3.670000e+02j,
          -4.270000e+02+5.210000e+02j]),
          'directory': '',
          'sweep_width': [5494.50549450549],
          'offset': [2249.20599998768],
          'points': [32692],
          'transmitter_frequency': [500.132249206],
          'nuclei': ['1H'],
          'binary_format': '<i4'}
