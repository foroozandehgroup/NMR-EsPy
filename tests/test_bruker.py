...
#
#     def test_nlp(self):
#         data = self.pdata_info.get_data()
#         sw = self.pdata_info.get_sw()
#         off = self.pdata_info.get_offset()
#
#     def test_make_fid(self):
#         p = np.array([
#             [1., 0., 7., 0.2],
#             [2., 0., 2., 0.1]
#         ])
...
#         offset = [5.]
#
#         fid = misc.mkfid(p, n, sw, offset=offset)


class TestMakeFid(unittest.TestCase):
